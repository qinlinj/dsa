...
// between is shorter than both of them. More formally, the iᵗʰ person can see the jᵗʰ
//  person if i < j and min(heights[i], heights[j]) > max(heights[i+1], heights[i+2
// ], ..., heights[j-1]). 
// 
//  Return an array answer of length n where answer[i] is the number of people the 
// iᵗʰ person can see to their right in the queue. 
// 
//  
//  Example 1: 
// 
...
//  
// 
//  Related Topics Array Stack Monotonic Stack 👍 2186 👎 67
